 ...
 * @author Ilana Shapiro: added a timer to the constructor that stops the side scroller game when the jumping square hits a scrolling object
 */
...
public class GUIController<T> extends World<Actor>
{
    ...
    private ChameleonRunner cam = new ChameleonRunner();
            ...
            DisplayMap displayMap, ResourceBundle res)
    {
		...
		//stops the side scroller game when the jumping square hits a scrolling object
            ...
            public void actionPerformed(ActionEvent evt)
            {
				...
				for (Actor a : actors)
		        {
		            ...
		            if (a.canMove() == false)
		            {
		            	...
		            	System.out.println("GAME OVER! Score: " + cam.stop()/2);
		            	stop();
		            	cam.stop();
		            	return;
		            }
    ...
    public void stop()
    {
        ...
        timer.stop();
        //ChameleonRunner.scrollerAdd().stop();
